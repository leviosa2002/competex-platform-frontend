...
const DialogOverlay = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Overlay> & {
    variant?: "default" | "tech" | "blurred"
  }
>(({ className, variant = "default", ...props }, ref) => {
  const variantClasses = {
    default: "bg-black/80",
    tech: "circuit-bg bg-black/80",
    blurred: "backdrop-blur-md bg-black/40"
  }
...
>(({ className, children, variant = "default", withParticles = false, ...props }, ref) => {
  const variantClasses = {
    default: "bg-background border shadow-lg",
    glass: "glassmorphism backdrop-blur-md border-0",
    holographic: "holographic bg-background border shadow-lg",
    tech: "tech-border bg-background shadow-lg"
  }
  
  return (
    <DialogPortal>
      <DialogOverlay variant={variant === "glass" ? "blurred" : "default"} />
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          variantClasses[variant],
          withParticles && "particle-container overflow-hidden",
          className
        )}
        {...props}
      >
