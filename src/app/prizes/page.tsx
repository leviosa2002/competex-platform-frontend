...
import { innovationPrizes, prizeCategories, sponsors } from "@/data/prizes"
...
export default function PrizesPage() {
  ...
  // Filter prizes based on category and search query
  const filteredPrizes = innovationPrizes.filter(prize => {
    // Category filter
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              >
                <Card variant="glass" className="p-6 sticky top-20">
                  ...
                  >
                    <label className="block text-sm font-medium mb-2">Search Prizes</label>
                                ...
                                {prize.eligibility && prize.eligibility.length > 0 && (
                                  <div className="mb-4">
                                    ...
                                    <ul className="list-disc pl-5 space-y-1 text-sm text-muted-foreground">
                                      {prize.eligibility.map((item, index) => (
                                        <motion.li 
                                          key={index}
